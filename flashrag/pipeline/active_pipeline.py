...
class IRCOTPipeline(BasicPipeline):
    ...
    # NOTE (Albert): Used same questions as COT_EXAMPLES from https://github.com/kilian-group/phantom-wiki/blob/63b1e6b9f589d5fbf36aacc8461ccff94e4b92f0/src/phantom_eval/prompts.py#L257
    IRCOT_EXAMPLE = f"""\
